make_delta_crootc_treatment_abs_effect_statistics <- function(inDF, var.cond, 
    ...
    modelt1 <- lmer(delta~Trt+Date+Cov2 + (1|Ring),data=tDF)
    ...
    modelt3 <- lmer(delta~Trt + Datef + Cov + Cov3 + Cov2 + (1|Ring),data=tDF)
