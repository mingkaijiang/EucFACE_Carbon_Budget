make_gpp_over_soil_phosphate_conc <- function(pDF=soil_phosphate_concentration) {
    ...
    p1 <- ggplot(plotDF1, aes(x=soil_P, y=GPP)) + 
        ...
        annotate("text", x=0.00019, y=2400, label= "2013", size=10) +
        ylim(750, 2500) + xlim(0.0001, 0.0002)
    ...
    p2 <- ggplot(plotDF2, aes(x=soil_P, y=GPP)) + 
        ...
        theme(panel.grid.minor=element_blank(),
              ...
              panel.grid.major=element_line(color="grey"),
              legend.position="none")+
        annotate("text", x=0.00019, y=2400, label= "2014", size=10) +
        ylim(750, 2500) + xlim(0.0001, 0.0002)
    ...
    p3 <- ggplot(plotDF3, aes(x=soil_P, y=GPP)) + 
        ylab(expression(paste("GPP (g C ", m^-2, " ", yr^-1, ")"))) +
        xlab("Soil phosphate concentration (%)")+
        ...
        annotate("text", x=0.00019, y=2400, label= "2015", size=10) +
        ylim(750, 2500) + xlim(0.0001, 0.0002)
    ...
    p4 <- ggplot(plotDF4, aes(x=soil_P, y=GPP)) + 
        ...
        theme(panel.grid.minor=element_blank(),
              ...
              panel.grid.major=element_line(color="grey"),
              legend.position="bottom")+
        annotate("text", x=0.00019, y=2400, label= "2016", size=10) +
        ylim(750, 2500) + xlim(0.0001, 0.0002)
    
    pdf("R_other/GPP_vs_soil_phosphate_concentration.pdf", width=12, height=8)
    require(cowplot)
