make_micc_treatment_abs_effect_statistics <- function(inDF, var.cond, 
    ...
    modelt1 <- lmer(Value~Trt + Datef + PreTrt + (1|Ring),data=tDF)
    ...
    modelt2 <- lmer(Value~Trt*Datef+PreTrt + (1|Ring),data=tDF)
