...
# 9. To-do list
    ...
    - Cat and Yolima may have litter biomass data
    ...
    - CH4 has no treatment effect (says Elise). Elise could help constraining this number based on estimates of nearby forest
    - Nam Jim indicated that his measurement probably won't start before Dec 2018
    - Compare turnover of root to FRED database
    - Share Google Drive with everyone
    - Share to-do list with everyone
<br/>
...
Attempted list but with problems:
    ...
    - CH4 calculation, still need to do gap-filling using DAMM model. But unsure about parameter fitting. 
