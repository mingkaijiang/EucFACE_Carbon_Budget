...
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    ...
    tables_by_ring$pool$value <- round(tables_by_ring$pool$value, 2)
...
#### Method In and out
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    tables_by_ring$inout$value <- round(tables_by_ring$inout$value, 2)
    kable(tables_by_ring$inout)
```

#### Method NPP
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    tables_by_ring$npp$value <- round(tables_by_ring$npp$value, 2)
...
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    ...
    tables_by_year$pool$value <- round(tables_by_year$pool$value, 2)
...
#### Method In and out
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    tables_by_year$inout$value <- round(tables_by_year$inout$value, 2)
    kable(tables_by_year$inout)
```

#### Method NPP
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    tables_by_year$npp$value <- round(tables_by_year$npp$value, 2)
