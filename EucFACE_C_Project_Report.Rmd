...
# 9. To-do list
    ...
    - soil moisture profile and its relationship to DOC, understorey LAI,  fineroot biomass, Rsoil
    - frass production and relationship with leaf N
    - R soil - inter-collar variability
    - Calculate NEP based on different method (partially done)
    - Use Sapwood depth to extrapolate % of live and dead wood (useful for P budget)
    - How to extract standing dead from total wood pool? Considering once they are dead, they don't do anything, is it worth to split wood pool into live and dead? 
    ...
    - soil moisture and understorey LAI
    - VOC data into MAESPA
