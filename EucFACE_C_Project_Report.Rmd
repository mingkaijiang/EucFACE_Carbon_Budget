...
### 6.5 Perform stats and regenerate summary table
This is to use pre-existing LAI as a covariate to predict all pools and fluxes:

#### Perform stats in the background
``` {r, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 7, fig.align="center", results="hide"}
...
#    kable(tables_by_ring_predicted$pool, digits=2)

```

#### Method In and out
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
#    kable(tables_by_ring_predicted$inout, digits=2)
```

#### Method NPP
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
#    kable(tables_by_ring_predicted$npp, digits=2)
```
...
# 9. To-do list
    ...
    - VOC data
    - Estimate mycorrhizal production 
