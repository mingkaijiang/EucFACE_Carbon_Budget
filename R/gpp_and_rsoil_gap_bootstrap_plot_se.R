gpp_and_rsoil_gap_bootstrap_plot_se <- function(inDF) {
    
    ### subseting NPP DF
    ### aCO2
    temDF <- inDF$npp[,c("term", "aCO2", "aCO2_conf")]
    temDF$aCO2_se <- temDF$aCO2_conf/1.96
    ...
    ### subsetting inout df
    temDF <- inDF$inout[,c("term", "aCO2", "aCO2_conf")]
    temDF$aCO2_se <- temDF$aCO2_conf/1.96
    ...
    plotDF$aCO2_sd <- plotDF$aCO2_se/1000
