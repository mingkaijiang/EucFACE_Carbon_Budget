make_eCO2_effect_on_GPP_normalized_plot_with_NPPmyco <- function(inDF) {
    ...
    D.col.list <- c("darkgreen", "seagreen", "chartreuse3", "yellowgreen", "chartreuse1", "green")
    ...
    col.list2 <- c("over_gpp"=A.col.list[1],                    
                   ...
                   "delta_microbial_c"=F.col.list[3],
    ...
    ### Plotting
    pdf("Output/eco2_effect_on_gpp_normalized_plot_with_NPPmyco.pdf", width=16, height=6)
