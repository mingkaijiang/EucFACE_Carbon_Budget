gpp_and_rsoil_gap_unbootstrap_plot <- function(inDF) {
    ...
    errDF$sd[errDF$cat=="NPP+Ra"] <- sqrt((plotDF[plotDF$term=="Leaf NPP","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Stem NPP","aCO2_sd"]^2 + 
                                              ...
                                              plotDF[plotDF$term=="Leaf consumption","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra leaf","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra stem","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra root","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra understorey","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Rgrowth","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="VOC","aCO2_sd"]^2)/13)
    
    errDF$sd[errDF$cat=="MAESPA"] <- sqrt((plotDF[plotDF$term=="GPP overstorey","aCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="GPP understorey","aCO2_sd"]^2)/2)
    
    errDF$conf[errDF$cat=="NPP+Ra"] <- errDF$sd[errDF$cat=="NPP+Ra"]
    errDF$conf[errDF$cat=="MAESPA"] <- errDF$sd[errDF$cat=="MAESPA"]
    
    errDF$pos[errDF$cat=="NPP+Ra"] <- errDF$sum[errDF$cat=="NPP+Ra"] + as.numeric(errDF$conf[errDF$cat=="NPP+Ra"])
    errDF$neg[errDF$cat=="NPP+Ra"] <- errDF$sum[errDF$cat=="NPP+Ra"] - as.numeric(errDF$conf[errDF$cat=="NPP+Ra"])
    errDF$pos[errDF$cat=="MAESPA"] <- errDF$sum[errDF$cat=="MAESPA"] + as.numeric(errDF$conf[errDF$cat=="MAESPA"])
    errDF$neg[errDF$cat=="MAESPA"] <- errDF$sum[errDF$cat=="MAESPA"] - as.numeric(errDF$conf[errDF$cat=="MAESPA"])
    ...
    errDF$sd[errDF$cat=="NPP+Ra"] <- sqrt((plotDF[plotDF$term=="Leaf NPP","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Stem NPP","eCO2_sd"]^2 + 
                                              ...
                                              plotDF[plotDF$term=="Leaf consumption","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra leaf","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra stem","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra root","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Ra understorey","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="Rgrowth","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="VOC","eCO2_sd"]^2)/13)
    
    errDF$sd[errDF$cat=="MAESPA"] <- sqrt((plotDF[plotDF$term=="GPP overstorey","eCO2_sd"]^2 + 
                                              plotDF[plotDF$term=="GPP understorey","eCO2_sd"]^2)/2)
